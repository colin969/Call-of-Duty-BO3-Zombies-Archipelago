...
weapon_data_set: dict[str, dict[str, WeaponData]] = {
    "vanilla": {
        ...
        "smg_capacity": WeaponData("smg", 2, ItemName.Weapon_Weevil),
        ...
        "smg_thompson": WeaponData("smg", 2, ItemName.Weapon_M1927),
...
map_weapon_lists: dict[str, WeaponLists] = {
    ...
    Maps.Nacht_Map_String: WeaponLists(
        table = "vanilla",
        vanilla = [
            "ar_accurate",
            "ar_cqb",
    ...
    Maps.Origins_Map_String: WeaponLists(
        table = "vanilla",
        vanilla = [
            "ar_accurate",
            "ar_cqb",
